...
func TestMigrations_SessionState(t *testing.T) {
	...
	require.Equal([]string{"pending", "pending", "pending", "active", "pending", "terminated",
		"pending", "canceling", "active", "canceling", "active", "terminated", "canceling", "terminated"}, validStates)
